    ...
    <main class="mx-auto max-w-4xl px-6 py-8">
      ...
      <div v-if="isLoading" class="mt-6 space-y-3">
        <div
          v-for="n in 5"
          :key="n"
          class="h-16 animate-pulse rounded-lg bg-surface"
        />
      </div>
      ...
      >
        ...
        <button
          class="mt-4 rounded-lg bg-accent px-5 py-2 text-sm font-semibold text-white transition-opacity hover:opacity-90"
